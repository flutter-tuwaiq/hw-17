...
class _DetailsViewState extends State<DetailsView> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i <= cartProvider.cartItems.length - 1; i++) {
      if (cartProvider.cartItems[i].name.toString().contains(widget.name)) {
        alreadyAdded = true;
        setState(() {});
      }
    }
                                ...
                                return InkWell(
                                  onTap: () {
                                    if (alreadyAdded != true) {
                                      ...
                                      Get.snackbar("Succesfully", "Item Added");
                                    } else {
                                      Get.snackbar("Error", "Alread added");
                                    }
                                  },
                                  child: Container(
                                    height: 60.h,
